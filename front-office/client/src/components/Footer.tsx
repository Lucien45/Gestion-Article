        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/articles" className="text-gray-300 hover:text-blue-400">
                  Articles
                </Link>
              </li>
              <li>
                <Link to="/categories" className="text-gray-300 hover:text-blue-400">
                  Catégories
                </Link>
              </li>
              <li>
                <Link to="/authors" className="text-gray-300 hover:text-blue-400">
                  Auteurs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/cookies" className="text-gray-300 hover:text-blue-400">
