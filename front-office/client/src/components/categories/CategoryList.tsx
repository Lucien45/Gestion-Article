      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {loading ? (
          (categories.length > 0
            ...
            <div
              key={idx}
              className="group bg-white dark:bg-neutral-800 rounded-lg p-6 shadow-sm animate-pulse"
            >
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
                  <div className="h-6 w-6 bg-blue-200 dark:bg-blue-800 rounded" />
                </div>
                <div>
                  <div className="h-5 w-24 bg-neutral-300 dark:bg-neutral-700 rounded mb-2" />
                  <div className="h-4 w-20 bg-neutral-200 dark:bg-neutral-600 rounded" />
                </div>
              </div>
            </div>
          ))
